...
<xsl:stylesheet version="1.0"
    ...
    <xsl:template match="/">
		...
		<xsl:if test="siemens/MEAS/sPat/lReorderingShift3D">
		    <userParameterLong>
                        <name>caipiFactor</name>
                        <value>
		...
		<xsl:if test="siemens/MEAS/sPat/ucPATMode">
		    <userParameterLong>
                        <name>PPIMode</name>
                        <value>
                            <xsl:value-of select="siemens/MEAS/sPat/ucPATMode" />
                        </value>
                    </userParameterLong>
		</xsl:if>

		<userParameterLong>
			<name>nCAIPI_Parts</name>
                        <value>
		...
		<userParameterLong>
			<name>nCAIPI_Lines</name>
                        <value>
                            <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[13]" />
                        </value>
                </userParameterLong>

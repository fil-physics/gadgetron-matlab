    ...
    <xsl:template match="/">
        ...
        <parallelImaging>
          ...
          <xsl:if test="(siemens/MEAS/sPat/ucRefScanMode = 1) or (siemens/MEAS/sPat/ucRefScanMode = 16) or (siemens/MEAS/sPat/ucRefScanMode = 32) or (siemens/MEAS/sPat/ucRefScanMode = 64)">
 		   ...
 		   <userParameterLong>
                        <name>NbEchoesBeforeBSPulse</name>
			<value>
			     <xsl:value-of select="siemens/MEAS/sWipMemBlock/alFree[10]" />
			</value>		
                    </userParameterLong>

 		  <userParameterDouble>
                     <name>BSPulseVoltage</name>
                     <value>
                           <xsl:value-of select="siemens/MEAS/sTXSPEC/BSPulseAmp"/>
                     </value>
                   </userParameterDouble>
		  ...
		  <userParameterDouble>
 		   ...
 		   <userParameterDouble>
                        <name>BSPulse_OffsetFrequencyHz</name>
			<value>
